...
$(document).ready(function () {
  ...
  var global_api = {
    ...
    /*顶部电影热图 js代码部分开始*/
  };var head_popular_images = $('.head_popular_movies_img');
  ...
  $.get(global_api.on_show, function (data, textStatus) {
    ...
    var on_show_global_temp = 0,
        on_show_num = data.count;
  ...
  function slick_temp(i) {
    return "<div>" + "<div class=\"on_show_hover\" class=\"image\">" + "<div class=\"on_show_poster_hint\">" + "<div id=\"on_show_poster_hint_name" + i + "\" class=\"on_show_movie_name\">" + "</div>" + "<div id=\"on_show_poster_hint_score" + i + "\" class=\"on_show_movie_score\">" + "</div>" + "</div>" + "<div class=\"on_show_hover_fore\"></div>" + "<img id=\"on_show_img" + i + "\" data-lazy=\"\" ult=\"123\" >" + "<div id=\"on_show_hover_info" + i + "\" class=\"on_show_hover_info\">" + "<div class=\"on_show_hover_title\"></div>" + "<div class=\"on_show_hover_rating\"></div>" + "<div class=\"on_show_hover_type\"></div>" + "<div class=\"on_show_hover_style\"></div>" + "<div class=\"on_show_hover_CAndL\"></div>" + "<div class=\"on_show_hover_pubdate\"></div>" + "<button id=\"on_show_button" + i + "\">购票</button>" + "</div>" + "</div>" + "</div>";
  }
  ...
  $.get(global_api.coming_soon, function (data, textStatus) {
    ...
    var coming_soon_global_temp = 0,
        coming_soon_num = data.count;
    for (var i = 0; i < data.count; i++) {
      $.get(global_api.movie_info + data.data[i], function (data, textStatus) {
  ...
  function coming_soon_slick_temp(i) {
    return "<div>" + "<div class=\"coming_soon_hover\" class=\"image\">" + "<div class=\"coming_soon_poster_hint\">" + "<div id=\"coming_soon_poster_hint_name" + i + "\" class=\"coming_soon_movie_name\">" + "</div>" + "</div>" + "<div class=\"coming_soon_hover_fore\"></div>" + "<img id=\"coming_soon_img" + i + "\" data-lazy=\"\" ult=\"123\" >" + "<div id=\"coming_soon_hover_info" + i + "\" class=\"coming_soon_hover_info\">" + "<div class=\"coming_soon_hover_title\"></div>" + "<div class=\"coming_soon_hover_type\"></div>" + "<div class=\"coming_soon_hover_style\"></div>" + "<div class=\"coming_soon_hover_CAndL\"></div>" + "<div class=\"coming_soon_hover_pubdate\"></div>" +
    // "<button>预售</button>"+
    "</div>" + "</div>" + "</div>";
  }
