...
$(document).ready(function () {
  var phone_check_init = function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
      var phone_container, phone_hint, loginData, phone_num, phone_check_btn;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              phone_container = document.createElement("div");

              phone_container.id = 'phone_container';

              phone_hint = document.createElement("div");
            ...
            case 9:
              ...
              phone_num = document.createElement("div");
              ...
              phone_check_btn = document.createElement("button");
    ...
    return function phone_check_init() {
  ...
  var movie_info_poster_img = document.getElementById("movie_info_poster_img"),
  ...
  function add_phone_check_input_and_btn_action() {
    var btn = document.getElementById("phone_check_btn"),
