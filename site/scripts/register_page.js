...
$(document).ready(function () {
  ...
  var container = document.getElementById('reg_container');
  ...
  function ask_sms(num) {
    $.get(global_api.get_sms + num, function (data) {}).error(function (err) {
  ...
  function set_btns_action(confirm_btn, resent_btn) {
    ...
    confirm_btn.onclick = function () {
      // 确认验证码函数
      register_req(document.getElementById('reg_phone_input_in').value, document.getElementById('sms_input').value, document.getElementById("pw_input").value);
    };
