											...
											$.get(global_api.get_cinema_info + hall_info.cinemaId, function (cinema_info) {
												...
												$.get(global_api.movie_info + movie_info.movieId, function (movie_detial) {
													...
													for (var j = 0; j < history.data[i].seats.length; j++) {
														seat_str = seat_str + history.data[i].seats[j][0] + "排" + history.data[i].seats[j][1] + "座&nbsp;&nbsp;";
													}
													data.seats = seat_str;
													...
													if (history.data[i].valid == false) {
														data.state = '已取票';
														var html_ = "<tbody><tr>" + "<td><img class=\'picture\' src=\'" + data.src + "\'/></td>" + "<td><div class=\'movie_name\'>" + data.name + "</div>" + "<div class=\'movie_time\'>" + data.time + "</div></td>" + "<td><div class=\'cinema_hall\'>" + data.cinema + "&nbsp" + data.hall + "</div>" + "<div class=\'seats\'>" + data.seats + "</div></td>" + "<td><div class=\'price\'>" + data.price + "</div></td>" + "<td><div class=\'state_over\'>" + data.state + "</div>" + "<div class=\'code\'>" + data.code + "</div></td>" + "</tr></tbody>";
														table.innerHTML += html_;
													} else {
														data.state = '待取票';
														var html_ = "<tbody><tr>" + "<td><img class=\'picture\' src=\'" + data.src + "\'/></td>" + "<td><div class=\'movie_name\'>" + data.name + "</div>" + "<div class=\'movie_time\'>" + data.time + "</div></td>" + "<td><div class=\'cinema_hall\'>" + data.cinema + "&nbsp" + data.hall + "</div>" + "<div class=\'seats\'>" + data.seats + "</div></td>" + "<td><div class=\'price\'>" + data.price + "</div></td>" + "<td><div class=\'state_wait\'>" + data.state + "</div>" + "<div class=\'code\'>" + data.code + "</div></td>" + "</tr></tbody>";
														table.innerHTML += html_;
													}
