...
$(document).ready(function () {
  var movie_info_part = function () {
    ...
    return function movie_info_part() {
      return _ref.apply(this, arguments);
    };
  }();

  // 选择场次部分
  var select_time_part = function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(select_time_clicked_showDate, select_time_clicked_cinemaId, select_time_clicked_cinema_name) {
      var day, i, day_times, cinema_hall;
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              // 获取电影院日排期
              _context2.next = 4;
              return get_day(select_time_clicked_showDate, select_time_clicked_cinemaId);
            ...
            case 7:
              ...
              _context2.next = 10;
              return get_day_times(day, i);

            case 10:
              day_times = _context2.sent;
              _context2.next = 13;
              return get_cinema_hall(day_times);

            case 13:
              cinema_hall = _context2.sent;
            ...
            case 18:
              ...
              select_time.onclick = function (event) {
                ...
                if (event.target.id.slice(18, 29) == 'select_seat') {
                  var arrTmp = event.target.id.split('_'),
    ...
    return function select_time_part(_x, _x2, _x3) {
  ...
  // 将当日所有排期各信息呈现在页面上
  var show_all_day_times = function () {
    var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(recent) {
      var select_cinema_count, cinemaHallId, movieOnShowId, showTime, showDate, i, cinemaId, brief, cinema;
      return regeneratorRuntime.wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              // 初始化一些变量
              select_cinema_count = recent.data[select_date_initial_count - 1].cinemaId.length, cinemaHallId = '', movieOnShowId = '', showTime = '';
              showDate = recent.data[select_date_initial_count - 1].showDate;
            ...
            case 3:
              if (!(i <= select_cinema_count)) {
                _context3.next = 15;
                break;
              }

              cinemaId = recent.data[select_date_initial_count - 1].cinemaId[i - 1];
              // 获取电影院日排期摘要

              _context3.next = 7;
              return get_brief(showDate, cinemaId);

            case 7:
              brief = _context3.sent;
              _context3.next = 10;
              return get_cinema(cinemaId);

            case 10:
              cinema = _context3.sent;
    ...
    return function show_all_day_times(_x4) {
      return _ref3.apply(this, arguments);
    };
  }();

  var selectPart = function () {
  ...
  var global_api = {
    ...
    /*取下movieId*/
  };var movieId = location.href.split('?')[1].split('#')[0].slice(8);
  /*取下movieId*/

  /*保存该电影的一些信息*/
  var global_movie_info = {
    length: 0,
    movieType: ''
    /*保存该电影的一些信息*/
  ...
  var select_date_initial_count = 1,
  ...
  function show_movie_info(movie_info) {
    ...
    var movie_info_poster = document.getElementById('movie_info_poster'),
    ...
    var movie_info_movie_style_tmp = '';
    for (var i = 0; i < movie_info.movieStyle.length; i++) {
  ...
  function show_cinema(i, cinemaId, brief, cinema) {
    var select_cinema_fragment = document.createDocumentFragment();
    var select_cinema_item = document.createElement('div');
    select_cinema_item.id = 'select_cinema_item' + i;
    select_cinema_item.className = 'select_cinema_item';
    var select_cinema_item_select_time = document.createElement('button');
    ...
    for (var j = 0; j < brief.showTime.length; j++) {
      var select_cinema_item_time = document.createElement('div');
  ...
  function select_cinema_remove_items() {
    var lengthTmp = select_cinema.childNodes.length;
    for (var i = 1; i < lengthTmp; i++) {
  ...
  function select_time_remove_items() {
    var lengthTmp = select_time.childNodes.length;
  ...
  function show_name_and_button(select_time_clicked_cinema_name) {
    var select_time_cinema_info = document.createElement('div');
    select_time_cinema_info.id = 'select_time_cinema_info';
    var select_time_change_cinema = document.createElement('button');
    select_time_change_cinema.id = 'select_time_change_cinema';
    select_time_change_cinema.innerHTML = '更改影院';
    var select_time_cinema_name = document.createElement('div');
    ...
    var select_time_title = document.createElement('div');
  ...
  function sort_select_time_items() {
    ...
    var arrTmp = Object.keys(objTmp);
    for (var _i = 2; _i < lengthTmp; _i++) {
      for (var j = 2; j < lengthTmp - 1; j++) {
        if (select_time.childNodes[j].id == objTmp[arrTmp[_i - 2]]) {
    ...
    for (var i = 1; i <= recent.count; i++) {
      ...
      var monthTmp = recent.data[i - 1].showDate.slice(5, 7);
      if (monthTmp.slice(0, 1) == '0') {
        monthTmp = monthTmp.slice(1, 2);
      }
      var dayTmp = recent.data[i - 1].showDate.slice(8, 10);
  ...
  function show_day_times_item_empty_hint() {
    var select_time_item_fragment = document.createDocumentFragment();
    var select_time_item = document.createElement('div');
  ...
  function show_day_times_item(day, i, day_times, cinema_hall) {
    ...
    var select_time_item_show_time = document.createElement('div');
    ...
    var select_time_item_end_time = document.createElement('div');
    select_time_item_end_time.className = 'select_time_item_end_time';
    var minutes_tmp = day_times.showTime.split(':')[1],
    ...
    var select_time_item_lang_and_movie_type = document.createElement('div');
    ...
    var select_time_item_cinema_hall_name = document.createElement('div');
    ...
    var select_time_item_price = document.createElement('div');
    select_time_item_price.className = 'select_time_item_price';
    select_time_item_price.innerHTML = '\uFFE5' + day_times.price;
    var select_time_item_select_seat = document.createElement('button');
